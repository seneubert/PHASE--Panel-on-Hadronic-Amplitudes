...
PHASE provides a platform for experiments to develop the technology used to publicly share. The network advocates open data policies and will search methods to ensure proper technical treatment of the data as well as proper attribution.
