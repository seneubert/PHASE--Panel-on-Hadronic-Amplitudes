...
PHASE provides a platform for experiments to develop the technology  is publicly shared. The network advocates open data policies and will search methods to ensure proper technical treatment of the data as well as proper attribution.
